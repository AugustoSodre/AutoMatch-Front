export interface UserPreferences {
  ...
  financials: {
    ...
    costTolerance: 'low' | 'medium' | 'high'; // Reflete IPVA, Seguro, Manutenção
  };

  // 3. Preferências Técnicas (O "O quê")
  technicalPreferences: {
    // Array de categorias permitidas no seu banco de dados
    categories: Array<'Hatch' | 'Sedan' | 'SUV' | 'Picape' | 'Eletrico' | 'Premium' | 'Classico'>;
    vehicleAge: '0km' | 'up_to_3_years' | 'up_to_10_years' | 'classic';
